...
func Demo() {
	...
	//Тесты
	query = `INSERT INTO Testing(Name, Course_id, Description) VALUES
		('Механика и движение', 1, 'Основы кинематики и динамики, законы Ньютона'),
		('Химические реакции', 2, 'Основные типы реакций, баланс, свойства веществ'),
		('Солнечная система', 3, 'Планеты, спутники, астероиды, строение и движение'),
		('Анализ литературного произведения', 4, 'Сюжет, композиция, образы, средства выразительности'),
		('Клетка и её строение', 5, 'Структура клеток, органеллы, процессы жизнедеятельности'),
		('Основы компьютерной архитектуры', 6, 'Аппаратное и программное обеспечение, принципы работы ПК'),
		('Структуры алгоритмов', 7, 'Линейные, разветвляющиеся, циклические алгоритмы, блок-схемы'),
		('Географическая номенклатура', 8, 'Рельеф, климат, природные зоны, страны и столицы'),
		('Хронология событий', 9, 'Основные исторические периоды, ключевые даты, личности'),
		('Основы алгебры', 10, 'Уравнения, неравенства, функции, графики, преобразования'),
		('Основы языков программирования', 11, 'Синтаксис, переменные, циклы, функции, операторы')
	;`
	_, err = db.Exec(query)
	if err != nil {
		panic(err)
